...
1. **הרשמת נהג** - נהג שולח הודעה פרטית למספר הבוט (`972534300803`) → נרשם אוטומטית
...
- WhatsApp session `972534300803` מחובר
...
3. **מספרים מרובים** - הוסף תמיכה בבוטים על מספרים נוספים מעבר ל-`972534300803`
